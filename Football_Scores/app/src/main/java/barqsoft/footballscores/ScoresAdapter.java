...
public class ScoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        mHolder.home_name.setContentDescription(context.getString(R.string.home_team_name_text) +
                cursor.getString(COL_HOME));

        mHolder.away_name.setText(cursor.getString(COL_AWAY));
        mHolder.away_name.setContentDescription(context.getString(R.string.away_team_name_text) +
                cursor.getString(COL_AWAY));

        mHolder.date.setText(cursor.getString(COL_MATCHTIME));
        mHolder.date.setContentDescription(context.getString(R.string.match_start_time_text) +
        ...
        mHolder.score.setContentDescription(context.getString(R.string.match_score_text) +
        ...
        if(mHolder.match_id == detail_match_id) {
            ...
            match_day.setContentDescription(context.getString(R.string.match_day_is_text) + match_day.getText());

            TextView league = (TextView) v.findViewById(R.id.league_textview);
            league.setText(Utilities.getLeague(cursor.getInt(COL_LEAGUE)));
            league.setContentDescription(context.getString(R.string.match_league_is_text) + league.getText());

            Button share_button = (Button) v.findViewById(R.id.share_button);
            share_button.setContentDescription(context.getString(R.string.share_match_scores_text));
