...
public class MyFetchService extends IntentService {
    ...
    public void getData (String timeFrame) {
        ...
        Log.d(TAG, "######## URL: " + fetch_build.toString());
        ...
        try {
            if (JSON_data != null) {
                ...
                if (matches.length() == 0) {
                    ...
                    Log.d(TAG, "####### No matches, processing dummy data.");
    ...
    private void processJSONdata (String JSONdata,Context mContext, boolean isReal)
    {
        ...
        try {
            ...
            for(int i = 0;i < matches.length();i++) {
                ...
                Log.d(TAG, "Home team: " + match_data.getString(HOME_TEAM) +
                           ", Away team: " + match_data.getString(AWAY_TEAM) +
                           ", League: " + League);
